...
const CORRENTE: EtapaDoPost[] = [
  { id: "e1", ordem: 10, nome: "Pauta", funcao: "Social Media",
    responsavelId: PRODUTOR, responsavel: "Marina Costa", status: "concluida",
    prazo: dia(10), concluidaEm: dia(10) },
  { id: "e2", ordem: 20, nome: "Conteúdo", funcao: "Redator",
    responsavelId: "a0000000-0000-0000-0000-000000000003", responsavel: "Carla Dias",
    status: "concluida", prazo: dia(12), concluidaEm: dia(12) },
  { id: "e3", ordem: 30, nome: "Layout", funcao: "Design",
    responsavelId: OUTRO, responsavel: "Bruno Lima", status: "concluida",
    prazo: dia(14), concluidaEm: dia(14) },
  ...
  { id: "e4", ordem: 40, nome: "Envio", funcao: "Gestao",
    responsavelId: null, responsavel: null, status: "em_ajustes",
    prazo: null, concluidaEm: null },
  { id: "e5", ordem: 41, nome: "Ajustes", funcao: "Design",
    responsavelId: OUTRO, responsavel: "Bruno Lima", status: "em_andamento",
    prazo: dia(16), concluidaEm: null },
  { id: "e6", ordem: 50, nome: "Programar", funcao: "Social Media",
    responsavelId: PRODUTOR, responsavel: "Marina Costa", status: "nao_iniciada",
    prazo: dia(17), concluidaEm: null },
];
...
const MINHAS: EtapaDeSocialMinha[] = [
  { ...CORRENTE[4], id: "m1", postId: "p1", tema: "Carrossel de dicas",
    cliente: "Mundo Verde", dataPublicacao: dia(17) },
  { ...CORRENTE[2], id: "m2", postId: "p2", nome: "Layout",
    status: "em_andamento", concluidaEm: null, tema: "Antes e depois",
    cliente: "Mundo Verde", dataPublicacao: dia(7) },
  { ...CORRENTE[0], id: "m3", postId: "p9", nome: "Pauta",
    status: "nao_iniciada", concluidaEm: null, prazo: null,
    tema: "Instagram 3 de 6 · mês que vem",
    cliente: "Óptica Visão", dataPublicacao: null },
];
...
export async function postsSemData(_clienteId?: string): Promise<PostDaAgencia[]> {
